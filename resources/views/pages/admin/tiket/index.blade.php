<x-admin::layout title="Tiket" header="Tiket">
    ...
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header pb-0 d-flex justify-content-between">
          <h6>Tiket List</h6>
          <a href="{{ route('admin.tiket.create') }}" class="btn bg-gradient-primary btn-sm">Add Tiket</a>
        </div>
              ...
              <tbody>
                @foreach ($tiket as $information)
                    ...
                    <td class="align-middle text-center text-sm">
                      <p class="text-xs text-secondary mb-0">{{ $information->harga }}</p>
                    </td>
                    ...
                    <td class="align-middle">
                        <a href="{{ route('admin.tiket.edit', $information->slug) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                        Edit
                        </a>
                        |
    ...
    <x-admin::modal id="delete-{{ $item->slug }}">
      <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
          ...
          <div class="modal-footer">
              <form action="{{ route('admin.tiket.destroy', $item->slug) }}" method="POST">
                  @method('DELETE')
                  @csrf
